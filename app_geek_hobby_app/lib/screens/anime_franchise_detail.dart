      ...
      body: _isLoading
        ...
        children: [
          ...
          if ((_franchise.description ?? '').trim().isNotEmpty) ...[
            ...
            Text(
              _normalizeDescription(_franchise.description!),
...
class _FranchiseEntryTile extends StatelessWidget {
  final Anime anime;
    ...
    return Card(
      ...
      child: InkWell(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (_) => AnimeDisplay(anime: anime)),
          );
        },
        child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        _FormatBadge(format: anime.format),
                        Text(
                          anime.yearReleased > 0
                              ? '${anime.yearReleased}'
                              : 'Unknown year',
                          style: TextStyle(
                            fontSize: 12,
  ...
  Widget _buildEntryImage() {
    final thumbUrl = anime.mediumImageUrl ?? anime.imageUrl;
